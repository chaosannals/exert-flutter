...
class SimpleRecorder extends StatefulWidget {
  ...
  const SimpleRecorder({Key? key, this.onBack}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        TextButton(
          style: ButtonStyle(
            foregroundColor: MaterialStateProperty.resolveWith((status) {
              return status.contains(MaterialState.pressed)
                  ? Colors.grey
                  : Colors.white;
            }),
            backgroundColor: MaterialStateProperty.resolveWith((status) {
              return status.contains(MaterialState.pressed)
                  ? Colors.lightBlue
                  : Colors.blue;
            }),
